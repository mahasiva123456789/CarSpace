...
import { setMake, setModel,setPriceRange,setCategory} from "../redux/searchSlice";
...
const PreOwnedCar = () => {
  ...
  const selectedModel = useSelector((state) => state.cars.selectedModel);
  ...
  return (
    <>
      ...
      <div className="car-search-title">
        <h1>Cars For <span>Sale</span> National Wild</h1>
      </div>
